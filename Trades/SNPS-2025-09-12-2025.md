...
## Thesis: Tactical Recovery from Earnings Destruction
...
Given the high-risk nature of the current situation with SNPS, a defined-risk options strategy is recommended for a 1-3 month time horizon. The bet is on a rebound following the earnings reaction.
